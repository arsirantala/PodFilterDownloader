...
Tools\fnr.exe --cl --dir "%cd%" --fileMask "IxothPodFilterDownloader_Setup.txt" --find "InstallerPath=IxothPodFilterDownloader_Setup.exe" --replace "InstallerPath=https://raw.githubusercontent.com/arsirantala/PodFilterDownloader/main/installer/IxothPodFilterDownloader_Setup.exe"
